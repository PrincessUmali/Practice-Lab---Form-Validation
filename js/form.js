...
function validForm() {
    ...
    else if (post.value < start.value) {
        alert("Please move the posting date after the start of the event!");
        post.focus();
        start.focus();
        return false;
    } 
    else if (post.value > finish.value) {
        alert("Please move the posting date before the end of the event!");
        post.focus();
        finish.focus();
        return false;
    }
